...
c=2208
l=2208
s="/faststorage/project/genint2_develop/GenerationInterval_V2/people/dmartinpestana/job_dmartinpestana.sh"
w=10
k="empty"
error="empty"
out="empty"
...
printf "\n"
printf "2) Checking if there is already a GenInt V2 job\n"
echo   "-----------------------------------------------"
...
then
	...
	then
		...
		echo ""
		echo "--------------------------- OUT ---------------------------"
		ssh ${u}@login.genome.au.dk 'cat '${outfile}''
		echo "-----------------------------------------------------------"
		echo ""
	fi
...
#If the job is running...
	...
	printf "\n"
	printf "4) Open a shh tunnel to the cluster\n"
	echo   "--------------------------------------------------------"
	...
	printf "\n   Connection established, open the browser at: http://127.0.0.1:${l}/\n"
